import sys
from typing import Generator ,List, Self, Turple  
import os 
import pandas as pd
import numpy as np
...
class ModelTrainer:
    def__init__(self): # type: ignore
        ...
        self.model_tariner_config = ModelTrainerConfig() # type: ignore
        



        Self.utils = MainUtils() # type: ignore
    ...
    def evaluate_model(self, X, y ,models):
        try:
            ...
            train_model_score = accuracy_score(y_test, y_train_pred)
    ...
    def get_best_model(self,
        ...
        try:
            ...
            best_model_anme = lsit(model_report.keys())
                list(model_report.values()).index(best_model_score)
            


            best_model_object = self.models[best_model_name] # type: ignore




            return best_model_name, best_model_object, best_model_score # type: ignore
        ...
        def finetune_best_model(self,
            ...
            def intiate_modeltrainer(self, train_array, test_array):
                try:
            ...
            best_model = self.finetune_best_model(
                best_model_anme = best_model_name,
            ...
            best_model_score = accuracy_score(y_test, y-pred)
            ...
            logging.info(
                f"saving model at path :{self.model_tarining_config.trained_model_path}"
            )        


            os.makedirs(os.path.dirname(self.model_tariner_config.trained_model_path),exist_ok = True)
