...
class PredictionPipeline:
    def__init__(self,request:request):
    ...
    def predict(self, features):
        ...
        try:
            ...
            model = self.utils.load_object(self.prediction_pipeline_config.model)
            preprocessor = self.utils.load_object(files_path=self.prediction_pipeline_config.preprocessor_path)
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            input_dataframe = input_dataframe.drop(columns="Unnamed: 0") in input_dataframe.columns else input_dataframe
